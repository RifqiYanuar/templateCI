...
<html lang="en">
  ...
  <section id="container">
      ...
      <div class="fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation"></div>
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="<?= base_url()?>index.php/user/Logout">Keluar</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
      ...
      *********************************************************************************************************************************************************** -->
      <!--sidebar start-->
      <aside>
          <div id="sidebar"  class="nav-collapse " style="background-color: gray;">
              <!-- sidebar menu start-->
              <ul class="sidebar-menu" id="nav-accordion" style="background-color: gray;">

              	  <p class="centered"><a href="<?= base_url()?>profile.html"><img src="<?=base_url()?>assets/saya.jpg" class="img-circle" width="50" ></a></p>
              	  <h5 class="centered">Rifqi Yanuar Almuzaki</h5>

                    <li class="active">
                    <li class="header"></li>
                    <a href="<?=base_url('index.php/user')?>">
                        <p class="material-icons" ><img src="<?=base_url()?>assets/house.png" class="img-circle" style="width: 30px;"><div style="margin-right: 85px; margin-top: -33px; font-size: 15px; float: right; color: black;">Beranda</div></p>
                  ...
                  <li class="active">
                      ...
                      <p class="material-icons" ><img src="<?=base_url()?>assets/user.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right; color: black;">Profil  </div></p>
                      </a>
                  </li>

                  <li class="active">
                      <a href="<?=base_url('index.php/gallery')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/img/galery.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right; color: black;">Galeri</div></p>
                      </a>
                  </li>

                  <li class="active">
                      <a href="<?=base_url('index.php/event')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/img/event.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right; color: black;">Event</div></p>
                      </a>
                  </li>
                  <li class="active">
                      <a href="<?=base_url('index.php/kategori')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/img/kategori.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right; color: black;">Kategori</div></p>
                      </a>
                  </li>
                  <li class="active">
                      <a href="<?=base_url('index.php/barang')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/img/barang.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right; color: black;">Barang</div></p>
                      </a>
                  </li>
                 <li class="active">
                      <a href="<?=base_url('index.php/pelanggan/DaftarPelanggan')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/img/daftar.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right; color: black;">Daftar</div></p>
                      </a>
                  </li>
                 <li class="active">
                      <a href="<?=base_url('index.php/pelanggan')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/img/data.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right; color: black;">Data</div></p>
                      </a>
                  </li>
