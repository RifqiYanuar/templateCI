                                ...
                                <h1 style="margin-left: 500px; margin-bottom: 30px;">Barang</h1>

                        <a style="margin: 35px;margin-left: 1px; background-color: #ffd777; border-color:white; " href="#tambah" class="btn btn-primary" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
